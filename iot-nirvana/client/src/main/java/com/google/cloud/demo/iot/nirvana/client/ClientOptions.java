...
public abstract class ClientOptions {
  ...
  private static final String INPUT_PARAM_GCP_PUBSUB_TOPIC_NAME = "pubSubTopicName";
  ...
  private Options initOptions() {
    ...
    Option optPubSubTopicName =
        new Option(INPUT_PARAM_GCP_PUBSUB_TOPIC_NAME, true, "PubSub topic name");
    optPubSubTopicName.setRequired(true);
    ...
    options.addOption(optPubSubTopicName);
  ...
  public String getPubSubTopicName() throws ClientException {
    return getStringOption(ClientOptions.INPUT_PARAM_GCP_PUBSUB_TOPIC_NAME);
  }
