...
public class InstanceRemoval extends AbstractTask {

  private static final long serialVersionUID = -1981951826229863468L;
  private static final Logger LOG = Logger.getLogger(InstanceRemoval.class.getName());
  ...
  protected void process(Map<String, String[]> parameterMap) throws Throwable {
    ...
    for (Instance instance : instanceList.getItems()) {
      compute
          .instances()
          .delete(Constants.GAE_APP_ID, Constants.GCE_MACHINE_DEFAULT_ZONE, instance.getName())
          .execute();
    }
